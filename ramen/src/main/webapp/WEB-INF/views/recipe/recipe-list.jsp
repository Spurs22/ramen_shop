	...
	<div class="main-container shadow-lg">
		<div class="content-container">
			...
			<div class="sub-menu">
				...
				<form name="searchForm" action="${pageContext.request.contextPath}/sbbs/list.do" method="post" style="display: flex; flex-direction: row; gap: 5px; height: 100%" >
					...
					<input type="text" name="keyword" value="${keyword}" class="form-control" style="width: 150px;">
					<button type="button" class="btn btn-primary" onclick="searchList();">검색</button>
				</form>
				
				<div>
					<button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/sbbs/write.do';">글올리기</button>
				</div>
			...
			<div class="product-container">
				<c:forEach var="recipe" items="${list}">
					<a class="product-item shadow" href="${recipeUrl}&id=${recipe.id}"> 
						<img class="product-img" src="${pageContext.request.contextPath}/resourse/picture/1.png">
						<div>${recipe.subject}</div>
						<div>${recipe.nickname}</div>
						<div>${recipe.hitCount}</div>

...
//			}
	...
	public List<ProductBoard> findPostsByMemberId(Long memberId) {
		...
		try {
			sql = "SELECT pb.id, member_id, REMAIN_QUANTITY, NAME, PRICE, content, TO_CHAR(created_date, 'yyyy-mm-dd') AS created_date, hit_count, ROUND(TRUNC((NVL(rating, 0)), 1)*2)/2 as rating, category_id, p.PICTURE " +
